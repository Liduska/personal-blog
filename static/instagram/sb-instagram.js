        ...
        jQuery('#sb_instagram.sbi').each(function () {
            ...
            jQuery.each(looparray, function (index, entry) {
                var userFeed = new instagramfeed({
                    ...
                    template: '<div class="sbi_item sbi_type_{{model.type}} sbi_new m-4" id="sbi_{{id}}" data-date="{{model.created_time_raw}}"><div class="sbi_photo_wrap"><a class="sbi_photo block w-full" href="{{link}}" target="_blank"><img src="{{image}}" alt="{{caption}}" width="200" height="200" /></a></div></div>',
                    ...
                    after: function () {
                        ...
                        function sbiSetPhotoHeight() {
                            if (imgRes !== 'thumbnail') {
                                ...
                                $self.find('.sbi_photo').css('width', sbi_photo_width)
                            }
                        }
                        sbiSetPhotoHeight();
                        ! function (i) {
